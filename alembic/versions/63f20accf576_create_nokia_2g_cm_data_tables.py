...
def downgrade():
    op.drop_table('trx', schema='nokia_raml2_gsm')
    op.drop_table('tre', schema='nokia_raml2_gsm')
    op.drop_table('tid', schema='nokia_raml2_gsm')
    op.drop_table('tcsm', schema='nokia_raml2_gsm')
    op.drop_table('smlc', schema='nokia_raml2_gsm')
    op.drop_table('ra', schema='nokia_raml2_gsm')
    op.drop_table('poc', schema='nokia_raml2_gsm')
    op.drop_table('pcu', schema='nokia_raml2_gsm')
    op.drop_table('pcm', schema='nokia_raml2_gsm')
    op.drop_table('nsvl', schema='nokia_raml2_gsm')
    op.drop_table('nse', schema='nokia_raml2_gsm')
    op.drop_table('mal', schema='nokia_raml2_gsm')
    op.drop_table('lapd', schema='nokia_raml2_gsm')
    op.drop_table('hoc', schema='nokia_raml2_gsm')
    op.drop_table('gpc', schema='nokia_raml2_gsm')
    op.drop_table('dap', schema='nokia_raml2_gsm')
    op.drop_table('bts', schema='nokia_raml2_gsm')
    op.drop_table('bsc', schema='nokia_raml2_gsm')
    op.drop_table('bcf', schema='nokia_raml2_gsm')
    op.drop_table('adjw', schema='nokia_raml2_gsm')
    op.drop_table('adjl', schema='nokia_raml2_gsm')
    op.drop_table('adce', schema='nokia_raml2_gsm')
