...
def upgrade():
    ...
    op.bulk_insert(managedobjects, [
        ...
        {'name': 'BFMIMOADAPTIVEPARACFG', 'parent_pk': 0, 'vendor_pk': 2, 'tech_pk': 3, 'modified_by': 0, 'added_by': 0},
        ...
        {'name': 'CNOPERATORSTANDARDQCI', 'parent_pk': 0, 'vendor_pk': 2, 'tech_pk': 3, 'modified_by': 0, 'added_by': 0},
        ...
        {'name': 'INTERRATHOCDMA1XRTTGROUP', 'parent_pk': 0, 'vendor_pk': 2, 'tech_pk': 3, 'modified_by': 0, 'added_by': 0},
        {'name': 'INTERRATHOCDMAHRPDGROUP', 'parent_pk': 0, 'vendor_pk': 2, 'tech_pk': 3, 'modified_by': 0, 'added_by': 0},
        ...
        {'name': 'INTERRATPOLICYCFGGROUP', 'parent_pk': 0, 'vendor_pk': 2, 'tech_pk': 3, 'modified_by': 0, 'added_by': 0},
