"""Create Ericsson CNAI load tables

Revision ID: 0d748b2c0067
Revises: a753295c449e
Create Date: 2019-01-23 02:29:29.490549
...
revision = '0d748b2c0067'
down_revision = 'a753295c449e'
branch_labels = None
depends_on = None
...
def downgrade():
    op.drop_table('UTRAN_NREL', schema='ericsson_cm')
    op.drop_table('UTRAN_EXTERNAL_CELL', schema='ericsson_cm')
    op.drop_table('TG', schema='ericsson_cm')
    op.drop_table('SITE', schema='ericsson_cm')
    op.drop_table('PRIORITY_PROFILE', schema='ericsson_cm')
    op.drop_table('OVERLAID_CELL', schema='ericsson_cm')
    op.drop_table('OUTER_CELL', schema='ericsson_cm')
    op.drop_table('NREL', schema='ericsson_cm')
    op.drop_table('MSC', schema='ericsson_cm')
    op.drop_table('INTERNAL_CELL', schema='ericsson_cm')
    op.drop_table('INNER_CELL', schema='ericsson_cm')
    op.drop_table('EXTERNAL_CELL', schema='ericsson_cm')
    op.drop_table('CHANNEL_GROUP', schema='ericsson_cm')
    op.drop_table('BSC', schema='ericsson_cm')
