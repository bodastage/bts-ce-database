...
def upgrade():
    ...
    *[sa.Column('FileName', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    sa.Column('UMFI_ACTIVE', sa.CHAR(length=250), autoincrement=False, nullable=True),
    sa.Column('UMFI_IDLE', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    sa.Column('COVERAGEU', sa.CHAR(length=250), autoincrement=False, nullable=True),
