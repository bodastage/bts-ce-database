"""Create MO views for Ericsson 4G

Revision ID: cb540db6ffbf
Revises: 9dd66b7e34a8
Create Date: 2018-05-15 05:19:20.202000
...
revision = 'cb540db6ffbf'
down_revision = '9dd66b7e34a8'
branch_labels = None
depends_on = None
...
ExternalGsmCell = ReplaceableObject(
    'ericsson_cm_4g."ExternalGsmCell"',
    """
...
ExternalUtranCell = ReplaceableObject(
    'ericsson_cm_4g."ExternalUtranCell"',
    """
...
NotificationIRP = ReplaceableObject(
    'ericsson_cm_4g."NotificationIRP"',
    """
...
Aal2PathDistributionUnit = ReplaceableObject(
    'ericsson_cm_4g."Aal2PathDistributionUnit"',
    """
...
Aal2QosCodePointProfile = ReplaceableObject(
    'ericsson_cm_4g."Aal2QosCodePointProfile"',
    """
...
Aal2RoutingCase = ReplaceableObject(
    'ericsson_cm_4g."Aal2RoutingCase"',
    """
...
AccessControlList = ReplaceableObject(
    'ericsson_cm_4g."AccessControlList"',
    """
...
AdmissionControl = ReplaceableObject(
    'ericsson_cm_4g."AdmissionControl"',
    """
...
AgpsPositioning = ReplaceableObject(
    'ericsson_cm_4g."AgpsPositioning"',
    """
...
AirIfLoadGenerator = ReplaceableObject(
    'ericsson_cm_4g."AirIfLoadGenerator"',
    """
...
AirIfLoadProfile = ReplaceableObject(
    'ericsson_cm_4g."AirIfLoadProfile"',
    """
...
Aisgv2FwDownload = ReplaceableObject(
    'ericsson_cm_4g."Aisgv2FwDownload"',
    """
...
AnrFunctionCdma20001xRtt = ReplaceableObject(
    'ericsson_cm_4g."AnrFunctionCdma20001xRtt"',
    """
...
AnrFunctionEUtran = ReplaceableObject(
    'ericsson_cm_4g."AnrFunctionEUtran"',
    """
...
AnrFunctionGeran = ReplaceableObject(
    'ericsson_cm_4g."AnrFunctionGeran"',
    """
...
AnrFunctionUtran = ReplaceableObject(
    'ericsson_cm_4g."AnrFunctionUtran"',
    """
...
AntennaNearUnit = ReplaceableObject(
    'ericsson_cm_4g."AntennaNearUnit"',
    """
...
AntennaUnitGroup = ReplaceableObject(
    'ericsson_cm_4g."AntennaUnitGroup"',
    """
...
ArpQosClassProfile = ReplaceableObject(
    'ericsson_cm_4g."ArpQosClassProfile"',
    """
...
AtmTrafficDescriptor = ReplaceableObject(
    'ericsson_cm_4g."AtmTrafficDescriptor"',
    """
...
AuthenticationOrder = ReplaceableObject(
    'ericsson_cm_4g."AuthenticationOrder"',
    """
...
AuthorizationOrder = ReplaceableObject(
    'ericsson_cm_4g."AuthorizationOrder"',
    """
...
AutoCellCapEstFunction = ReplaceableObject(
    'ericsson_cm_4g."AutoCellCapEstFunction"',
    """
...
AutoProvisioning = ReplaceableObject(
    'ericsson_cm_4g."AutoProvisioning"',
    """
...
BbProcessingResource = ReplaceableObject(
    'ericsson_cm_4g."BbProcessingResource"',
    """
...
BoundaryOrdinaryClock = ReplaceableObject(
    'ericsson_cm_4g."BoundaryOrdinaryClock"',
    """
...
BrmBackupHousekeeping = ReplaceableObject(
    'ericsson_cm_4g."BrmBackupHousekeeping"',
    """
...
BrmBackupLabelStore = ReplaceableObject(
    'ericsson_cm_4g."BrmBackupLabelStore"',
    """
...
BrmBackupManager = ReplaceableObject(
    'ericsson_cm_4g."BrmBackupManager"',
    """
...
BrmBackupScheduler = ReplaceableObject(
    'ericsson_cm_4g."BrmBackupScheduler"',
    """
...
BrmCalendarBasedPeriodicEvent = ReplaceableObject(
    'ericsson_cm_4g."BrmCalendarBasedPeriodicEvent"',
    """
...
BrmFailsafeBackup = ReplaceableObject(
    'ericsson_cm_4g."BrmFailsafeBackup"',
    """
...
BrmPeriodicEvent = ReplaceableObject(
    'ericsson_cm_4g."BrmPeriodicEvent"',
    """
...
BrmRollbackAtRestore = ReplaceableObject(
    'ericsson_cm_4g."BrmRollbackAtRestore"',
    """
...
CapacityChannelBandwidth = ReplaceableObject(
    'ericsson_cm_4g."CapacityChannelBandwidth"',
    """
...
CapacityConnectedUsers = ReplaceableObject(
    'ericsson_cm_4g."CapacityConnectedUsers"',
    """
...
CapacityFeatureLicense = ReplaceableObject(
    'ericsson_cm_4g."CapacityFeatureLicense"',
    """
...
CapacityLicenses = ReplaceableObject(
    'ericsson_cm_4g."CapacityLicenses"',
    """
...
CarrierAggregationFunction = ReplaceableObject(
    'ericsson_cm_4g."CarrierAggregationFunction"',
    """
...
Cdma2000SessionContinuity = ReplaceableObject(
    'ericsson_cm_4g."Cdma2000SessionContinuity"',
    """
...
CellSleepFunction = ReplaceableObject(
    'ericsson_cm_4g."CellSleepFunction"',
    """
...
CellSleepNodeFunction = ReplaceableObject(
    'ericsson_cm_4g."CellSleepNodeFunction"',
    """
...
CertMCapabilities = ReplaceableObject(
    'ericsson_cm_4g."CertMCapabilities"',
    """
...
ChannelSwitching = ReplaceableObject(
    'ericsson_cm_4g."ChannelSwitching"',
    """
...
CommonChannelResourcesDl = ReplaceableObject(
    'ericsson_cm_4g."CommonChannelResourcesDl"',
    """
...
CommonChannelResourcesUl = ReplaceableObject(
    'ericsson_cm_4g."CommonChannelResourcesUl"',
    """
...
CommunicationContexts = ReplaceableObject(
    'ericsson_cm_4g."CommunicationContexts"',
    """
...
ConfigurationVersion = ReplaceableObject(
    'ericsson_cm_4g."ConfigurationVersion"',
    """
...
CoverageRelation = ReplaceableObject(
    'ericsson_cm_4g."CoverageRelation"',
    """
...
CpriLinkSupervision = ReplaceableObject(
    'ericsson_cm_4g."CpriLinkSupervision"',
    """
...
CsfbForLimitedDualRadioUE = ReplaceableObject(
    'ericsson_cm_4g."CsfbForLimitedDualRadioUE"',
    """
...
CsfbToGeranUtran = ReplaceableObject(
    'ericsson_cm_4g."CsfbToGeranUtran"',
    """
...
DataCollectionGeneration = ReplaceableObject(
    'ericsson_cm_4g."DataCollectionGeneration"',
    """
...
DataRadioBearer = ReplaceableObject(
    'ericsson_cm_4g."DataRadioBearer"',
    """
...
DifferentiatedAdmissionControl = ReplaceableObject(
    'ericsson_cm_4g."DifferentiatedAdmissionControl"',
    """
...
DlBasebandCapacity = ReplaceableObject(
    'ericsson_cm_4g."DlBasebandCapacity"',
    """
...
DownlinkBaseBandPool = ReplaceableObject(
    'ericsson_cm_4g."DownlinkBaseBandPool"',
    """
...
DualAntDlPerfPkg = ReplaceableObject(
    'ericsson_cm_4g."DualAntDlPerfPkg"',
    """
...
DualLayBeamfPerfPkg = ReplaceableObject(
    'ericsson_cm_4g."DualLayBeamfPerfPkg"',
    """
...
DynamicGBRAdmCtrl = ReplaceableObject(
    'ericsson_cm_4g."DynamicGBRAdmCtrl"',
    """
...
DynamicQoSModification = ReplaceableObject(
    'ericsson_cm_4g."DynamicQoSModification"',
    """
...
EmergencyUnlock = ReplaceableObject(
    'ericsson_cm_4g."EmergencyUnlock"',
    """
...
EnhCellIdInTraces = ReplaceableObject(
    'ericsson_cm_4g."EnhCellIdInTraces"',
    """
...
EnrollmentAuthority = ReplaceableObject(
    'ericsson_cm_4g."EnrollmentAuthority"',
    """
...
EnrollmentServer = ReplaceableObject(
    'ericsson_cm_4g."EnrollmentServer"',
    """
...
EnrollmentServerGroup = ReplaceableObject(
    'ericsson_cm_4g."EnrollmentServerGroup"',
    """
...
EquipmentClockReference = ReplaceableObject(
    'ericsson_cm_4g."EquipmentClockReference"',
    """
...
EquipmentDiscovery = ReplaceableObject(
    'ericsson_cm_4g."EquipmentDiscovery"',
    """
...
EquipmentSupportFunction = ReplaceableObject(
    'ericsson_cm_4g."EquipmentSupportFunction"',
    """
...
EthernetBridgePort = ReplaceableObject(
    'ericsson_cm_4g."EthernetBridgePort"',
    """
...
EthernetInterface = ReplaceableObject(
    'ericsson_cm_4g."EthernetInterface"',
    """
...
EthernetSwitchFabric = ReplaceableObject(
    'ericsson_cm_4g."EthernetSwitchFabric"',
    """
...
EthernetSwitchingAdm = ReplaceableObject(
    'ericsson_cm_4g."EthernetSwitchingAdm"',
    """
...
EthernetSwitchModule = ReplaceableObject(
    'ericsson_cm_4g."EthernetSwitchModule"',
    """
...
EthernetSwitchModulePort = ReplaceableObject(
    'ericsson_cm_4g."EthernetSwitchModulePort"',
    """
...
EthernetSwitchPort = ReplaceableObject(
    'ericsson_cm_4g."EthernetSwitchPort"',
    """
...
EUtranCellRelation = ReplaceableObject(
    'ericsson_cm_4g."EUtranCellRelation"',
    """
...
EUtranFreqRelation = ReplaceableObject(
    'ericsson_cm_4g."EUtranFreqRelation"',
    """
...
EUtranFrequency = ReplaceableObject(
    'ericsson_cm_4g."EUtranFrequency"',
    """
...
EventCapabilities = ReplaceableObject(
    'ericsson_cm_4g."EventCapabilities"',
    """
...
ExchangeTerminal = ReplaceableObject(
    'ericsson_cm_4g."ExchangeTerminal"',
    """
...
ExchangeTerminalIp = ReplaceableObject(
    'ericsson_cm_4g."ExchangeTerminalIp"',
    """
...
ExternalENodeBFunction = ReplaceableObject(
    'ericsson_cm_4g."ExternalENodeBFunction"',
    """
...
ExternalEUtranCellFDD = ReplaceableObject(
    'ericsson_cm_4g."ExternalEUtranCellFDD"',
    """
...
ExternalEutranFrequency = ReplaceableObject(
    'ericsson_cm_4g."ExternalEutranFrequency"',
    """
...
ExternalEUtranPlmn = ReplaceableObject(
    'ericsson_cm_4g."ExternalEUtranPlmn"',
    """
...
ExternalGsmFreq = ReplaceableObject(
    'ericsson_cm_4g."ExternalGsmFreq"',
    """
...
ExternalGsmFreqGroup = ReplaceableObject(
    'ericsson_cm_4g."ExternalGsmFreqGroup"',
    """
...
ExternalGsmPlmn = ReplaceableObject(
    'ericsson_cm_4g."ExternalGsmPlmn"',
    """
...
ExternalUtranFreq = ReplaceableObject(
    'ericsson_cm_4g."ExternalUtranFreq"',
    """
...
ExternalUtranPlmn = ReplaceableObject(
    'ericsson_cm_4g."ExternalUtranPlmn"',
    """
...
FieldReplaceableUnit = ReplaceableObject(
    'ericsson_cm_4g."FieldReplaceableUnit"',
    """
...
FilePullCapabilities = ReplaceableObject(
    'ericsson_cm_4g."FilePullCapabilities"',
    """
...
FrequencySyncIO = ReplaceableObject(
    'ericsson_cm_4g."FrequencySyncIO"',
    """
...
GeneralProcessorUnit = ReplaceableObject(
    'ericsson_cm_4g."GeneralProcessorUnit"',
    """
...
GeranCellRelation = ReplaceableObject(
    'ericsson_cm_4g."GeranCellRelation"',
    """
...
GeranFreqGroupRelation = ReplaceableObject(
    'ericsson_cm_4g."GeranFreqGroupRelation"',
    """
...
GigaBitEthernet = ReplaceableObject(
    'ericsson_cm_4g."GigaBitEthernet"',
    """
...
GsmSessionContinuity = ReplaceableObject(
    'ericsson_cm_4g."GsmSessionContinuity"',
    """
...
HsDschResources = ReplaceableObject(
    'ericsson_cm_4g."HsDschResources"',
    """
...
IntegrationUnlock = ReplaceableObject(
    'ericsson_cm_4g."IntegrationUnlock"',
    """
...
InterFrequencyLoadBalancing = ReplaceableObject(
    'ericsson_cm_4g."InterFrequencyLoadBalancing"',
    """
...
InterFrequencyLTEHandover = ReplaceableObject(
    'ericsson_cm_4g."InterFrequencyLTEHandover"',
    """
...
InterFrequencySessionContinuity = ReplaceableObject(
    'ericsson_cm_4g."InterFrequencySessionContinuity"',
    """
...
InternalEthernetPort = ReplaceableObject(
    'ericsson_cm_4g."InternalEthernetPort"',
    """
...
IntraLTEHODataFwd = ReplaceableObject(
    'ericsson_cm_4g."IntraLTEHODataFwd"',
    """
...
IpAccessHostGpb = ReplaceableObject(
    'ericsson_cm_4g."IpAccessHostGpb"',
    """
...
IpAccessHostPool = ReplaceableObject(
    'ericsson_cm_4g."IpAccessHostPool"',
    """
...
IpAccessHostSpb = ReplaceableObject(
    'ericsson_cm_4g."IpAccessHostSpb"',
    """
...
IpEthPacketDataRouter = ReplaceableObject(
    'ericsson_cm_4g."IpEthPacketDataRouter"',
    """
...
Ipv4DestNetwork = ReplaceableObject(
    'ericsson_cm_4g."Ipv4DestNetwork"',
    """
...
Ipv4StaticRoute = ReplaceableObject(
    'ericsson_cm_4g."Ipv4StaticRoute"',
    """
...
Ipv4StaticRouteTable = ReplaceableObject(
    'ericsson_cm_4g."Ipv4StaticRouteTable"',
    """
...
IPv6RoutingTable = ReplaceableObject(
    'ericsson_cm_4g."IPv6RoutingTable"',
    """
...
KeyFileInformation = ReplaceableObject(
    'ericsson_cm_4g."KeyFileInformation"',
    """
...
KeyFileManagement = ReplaceableObject(
    'ericsson_cm_4g."KeyFileManagement"',
    """
...
LdapAuthenticationMethod = ReplaceableObject(
    'ericsson_cm_4g."LdapAuthenticationMethod"',
    """
...
LinkTransmissionProfile = ReplaceableObject(
    'ericsson_cm_4g."LinkTransmissionProfile"',
    """
...
LoadBalancingFunction = ReplaceableObject(
    'ericsson_cm_4g."LoadBalancingFunction"',
    """
...
LogicalChannelGroup = ReplaceableObject(
    'ericsson_cm_4g."LogicalChannelGroup"',
    """
...
MACConfiguration = ReplaceableObject(
    'ericsson_cm_4g."MACConfiguration"',
    """
...
MaintenanceUser = ReplaceableObject(
    'ericsson_cm_4g."MaintenanceUser"',
    """
...
MaintenanceUserSecurity = ReplaceableObject(
    'ericsson_cm_4g."MaintenanceUserSecurity"',
    """
...
ManagedElementData = ReplaceableObject(
    'ericsson_cm_4g."ManagedElementData"',
    """
...
MaximumCellRange = ReplaceableObject(
    'ericsson_cm_4g."MaximumCellRange"',
    """
...
MbmsServiceArea = ReplaceableObject(
    'ericsson_cm_4g."MbmsServiceArea"',
    """
...
MdtConfiguration = ReplaceableObject(
    'ericsson_cm_4g."MdtConfiguration"',
    """
...
MeasurementDefinition = ReplaceableObject(
    'ericsson_cm_4g."MeasurementDefinition"',
    """
...
MediumAccessUnit = ReplaceableObject(
    'ericsson_cm_4g."MediumAccessUnit"',
    """
...
MimoSleepFunction = ReplaceableObject(
    'ericsson_cm_4g."MimoSleepFunction"',
    """
...
MobCtrlAtPoorCov = ReplaceableObject(
    'ericsson_cm_4g."MobCtrlAtPoorCov"',
    """
...
MocnCellProfile = ReplaceableObject(
    'ericsson_cm_4g."MocnCellProfile"',
    """
...
MpClusterHandling = ReplaceableObject(
    'ericsson_cm_4g."MpClusterHandling"',
    """
...
MpProcessingResource = ReplaceableObject(
    'ericsson_cm_4g."MpProcessingResource"',
    """
...
MulticastAntennaBranch = ReplaceableObject(
    'ericsson_cm_4g."MulticastAntennaBranch"',
    """
...
MultiErabsPerUser = ReplaceableObject(
    'ericsson_cm_4g."MultiErabsPerUser"',
    """
...
NodeBLocalCellGroup = ReplaceableObject(
    'ericsson_cm_4g."NodeBLocalCellGroup"',
    """
...
NodeBSectorCarrier = ReplaceableObject(
    'ericsson_cm_4g."NodeBSectorCarrier"',
    """
...
NodeGroupSyncMember = ReplaceableObject(
    'ericsson_cm_4g."NodeGroupSyncMember"',
    """
...
NodeManagementFunction = ReplaceableObject(
    'ericsson_cm_4g."NodeManagementFunction"',
    """
...
NonPlannedPciDrxProfile = ReplaceableObject(
    'ericsson_cm_4g."NonPlannedPciDrxProfile"',
    """
...
NtpFrequencySync = ReplaceableObject(
    'ericsson_cm_4g."NtpFrequencySync"',
    """
...
OamTrafficClass = ReplaceableObject(
    'ericsson_cm_4g."OamTrafficClass"',
    """
...
OctAntUlPerfPkg = ReplaceableObject(
    'ericsson_cm_4g."OctAntUlPerfPkg"',
    """
...
OnSiteActivities = ReplaceableObject(
    'ericsson_cm_4g."OnSiteActivities"',
    """
...
OperatorDefinedQci = ReplaceableObject(
    'ericsson_cm_4g."OperatorDefinedQci"',
    """
...
OptionalFeatureLicense = ReplaceableObject(
    'ericsson_cm_4g."OptionalFeatureLicense"',
    """
...
OptionalFeatures = ReplaceableObject(
    'ericsson_cm_4g."OptionalFeatures"',
    """
...
PacketFrequencySyncRef = ReplaceableObject(
    'ericsson_cm_4g."PacketFrequencySyncRef"',
    """
...
PlmnIdentityGroup = ReplaceableObject(
    'ericsson_cm_4g."PlmnIdentityGroup"',
    """
...
PmInitiatedUeMeasurements = ReplaceableObject(
    'ericsson_cm_4g."PmInitiatedUeMeasurements"',
    """
...
PmMeasurementCapabilities = ReplaceableObject(
    'ericsson_cm_4g."PmMeasurementCapabilities"',
    """
...
PmUeMeasControl = ReplaceableObject(
    'ericsson_cm_4g."PmUeMeasControl"',
    """
...
PmUlInterferenceReport = ReplaceableObject(
    'ericsson_cm_4g."PmUlInterferenceReport"',
    """
...
PositioningServiceClass = ReplaceableObject(
    'ericsson_cm_4g."PositioningServiceClass"',
    """
...
PowerDistribution = ReplaceableObject(
    'ericsson_cm_4g."PowerDistribution"',
    """
...
PredefRbsScannerGpeh = ReplaceableObject(
    'ericsson_cm_4g."PredefRbsScannerGpeh"',
    """
...
PreschedulingProfile = ReplaceableObject(
    'ericsson_cm_4g."PreschedulingProfile"',
    """
...
QciProfilePredefined = ReplaceableObject(
    'ericsson_cm_4g."QciProfilePredefined"',
    """
...
QosAwareScheduler = ReplaceableObject(
    'ericsson_cm_4g."QosAwareScheduler"',
    """
...
QuadAntUlPerfPkg = ReplaceableObject(
    'ericsson_cm_4g."QuadAntUlPerfPkg"',
    """
...
RadioBearerTable = ReplaceableObject(
    'ericsson_cm_4g."RadioBearerTable"',
    """
...
RadioEquipmentClock = ReplaceableObject(
    'ericsson_cm_4g."RadioEquipmentClock"',
    """
...
RadioEquipmentClockReference = ReplaceableObject(
    'ericsson_cm_4g."RadioEquipmentClockReference"',
    """
...
RadioUnitCascading = ReplaceableObject(
    'ericsson_cm_4g."RadioUnitCascading"',
    """
...
RbsEventStreamer = ReplaceableObject(
    'ericsson_cm_4g."RbsEventStreamer"',
    """
...
RbsSynchronization = ReplaceableObject(
    'ericsson_cm_4g."RbsSynchronization"',
    """
...
RedirectWithNacc = ReplaceableObject(
    'ericsson_cm_4g."RedirectWithNacc"',
    """
...
ReliableProgramUniter = ReplaceableObject(
    'ericsson_cm_4g."ReliableProgramUniter"',
    """
...
ReportConfigA1Prim = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigA1Prim"',
    """
...
ReportConfigA1Sec = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigA1Sec"',
    """
...
ReportConfigA5Anr = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigA5Anr"',
    """
...
ReportConfigA5DlComp = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigA5DlComp"',
    """
...
ReportConfigA5SoftLock = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigA5SoftLock"',
    """
...
ReportConfigA5UlTrig = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigA5UlTrig"',
    """
...
ReportConfigB1Geran = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB1Geran"',
    """
...
ReportConfigB1Utra = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB1Utra"',
    """
...
ReportConfigB2Cdma2000 = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2Cdma2000"',
    """
...
ReportConfigB2Cdma20001xRtt = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2Cdma20001xRtt"',
    """
...
ReportConfigB2CdmaRttUlTrig = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2CdmaRttUlTrig"',
    """
...
ReportConfigB2CdmaUlTrig = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2CdmaUlTrig"',
    """
...
ReportConfigB2Geran = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2Geran"',
    """
...
ReportConfigB2GeranUlTrig = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2GeranUlTrig"',
    """
...
ReportConfigB2Utra = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2Utra"',
    """
...
ReportConfigB2UtraUlTrig = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigB2UtraUlTrig"',
    """
...
ReportConfigCsfbCdma2000 = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigCsfbCdma2000"',
    """
...
ReportConfigCsfbGeran = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigCsfbGeran"',
    """
...
ReportConfigCsfbUtra = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigCsfbUtra"',
    """
...
ReportConfigCsg = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigCsg"',
    """
...
ReportConfigEUtraBadCovPrim = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraBadCovPrim"',
    """
...
ReportConfigEUtraBadCovSec = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraBadCovSec"',
    """
...
ReportConfigEUtraBestCell = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraBestCell"',
    """
...
ReportConfigEUtraBestCellAnr = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraBestCellAnr"',
    """
...
ReportConfigEUtraIFA3UlTrig = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraIFA3UlTrig"',
    """
...
ReportConfigEUtraIFBestCell = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraIFBestCell"',
    """
...
ReportConfigEUtraInterFreqLb = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraInterFreqLb"',
    """
...
ReportConfigEUtraInterFreqMbms = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraInterFreqMbms"',
    """
...
ReportConfigEUtraIntraFreqPm = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigEUtraIntraFreqPm"',
    """
...
ReportConfigInterRatLb = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigInterRatLb"',
    """
...
ReportConfigSCellA1A2 = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigSCellA1A2"',
    """
...
ReportConfigSCellA4 = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigSCellA4"',
    """
...
ReportConfigSCellA6 = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigSCellA6"',
    """
...
ReportConfigSearch = ReplaceableObject(
    'ericsson_cm_4g."ReportConfigSearch"',
    """
...
ResourcePartitions = ReplaceableObject(
    'ericsson_cm_4g."ResourcePartitions"',
    """
...
RetConfigurationMgt = ReplaceableObject(
    'ericsson_cm_4g."RetConfigurationMgt"',
    """
...
RetuDeviceGroup = ReplaceableObject(
    'ericsson_cm_4g."RetuDeviceGroup"',
    """
...
RncConfigLimits = ReplaceableObject(
    'ericsson_cm_4g."RncConfigLimits"',
    """
...
RnlQosClassProfile = ReplaceableObject(
    'ericsson_cm_4g."RnlQosClassProfile"',
    """
...
RouteTableIPv4Static = ReplaceableObject(
    'ericsson_cm_4g."RouteTableIPv4Static"',
    """
...
SctpAssociation = ReplaceableObject(
    'ericsson_cm_4g."SctpAssociation"',
    """
...
SectorEquipmentFunction = ReplaceableObject(
    'ericsson_cm_4g."SectorEquipmentFunction"',
    """
...
SecurityHandling = ReplaceableObject(
    'ericsson_cm_4g."SecurityHandling"',
    """
...
ServiceSpecificDRX = ReplaceableObject(
    'ericsson_cm_4g."ServiceSpecificDRX"',
    """
...
ServiceTriggeredMobility = ReplaceableObject(
    'ericsson_cm_4g."ServiceTriggeredMobility"',
    """
...
SharedNetworkSupport = ReplaceableObject(
    'ericsson_cm_4g."SharedNetworkSupport"',
    """
...
SignalingRadioBearer = ReplaceableObject(
    'ericsson_cm_4g."SignalingRadioBearer"',
    """
...
SingLayBeamfPerfPkg = ReplaceableObject(
    'ericsson_cm_4g."SingLayBeamfPerfPkg"',
    """
...
SpidHoWhiteList = ReplaceableObject(
    'ericsson_cm_4g."SpidHoWhiteList"',
    """
...
SpidRATFreqPrio = ReplaceableObject(
    'ericsson_cm_4g."SpidRATFreqPrio"',
    """
...
StreamingCapabilities = ReplaceableObject(
    'ericsson_cm_4g."StreamingCapabilities"',
    """
...
SubscriberProfileID = ReplaceableObject(
    'ericsson_cm_4g."SubscriberProfileID"',
    """
...
SubscrProfileIdHandling = ReplaceableObject(
    'ericsson_cm_4g."SubscrProfileIdHandling"',
    """
...
SwitchInternalLinkPort = ReplaceableObject(
    'ericsson_cm_4g."SwitchInternalLinkPort"',
    """
...
Synchronization = ReplaceableObject(
    'ericsson_cm_4g."Synchronization"',
    """
...
SystemFunctions = ReplaceableObject(
    'ericsson_cm_4g."SystemFunctions"',
    """
...
TCPOptimization = ReplaceableObject(
    'ericsson_cm_4g."TCPOptimization"',
    """
...
TdScdmaSessionContinuity = ReplaceableObject(
    'ericsson_cm_4g."TdScdmaSessionContinuity"',
    """
...
Tm7ModeSwitching = ReplaceableObject(
    'ericsson_cm_4g."Tm7ModeSwitching"',
    """
...
TnlCchQosClassProfile = ReplaceableObject(
    'ericsson_cm_4g."TnlCchQosClassProfile"',
    """
...
TnlDchQosClassProfile = ReplaceableObject(
    'ericsson_cm_4g."TnlDchQosClassProfile"',
    """
...
TnlHspaQosClassProfile = ReplaceableObject(
    'ericsson_cm_4g."TnlHspaQosClassProfile"',
    """
...
TnlIuQosClassProfile = ReplaceableObject(
    'ericsson_cm_4g."TnlIuQosClassProfile"',
    """
...
TrafficAwarePowerSave = ReplaceableObject(
    'ericsson_cm_4g."TrafficAwarePowerSave"',
    """
...
TrafficClassPsInt = ReplaceableObject(
    'ericsson_cm_4g."TrafficClassPsInt"',
    """
...
TrafficManagement = ReplaceableObject(
    'ericsson_cm_4g."TrafficManagement"',
    """
...
TrafficScheduler = ReplaceableObject(
    'ericsson_cm_4g."TrafficScheduler"',
    """
...
TransportNetwork = ReplaceableObject(
    'ericsson_cm_4g."TransportNetwork"',
    """
...
TrustedCertificate = ReplaceableObject(
    'ericsson_cm_4g."TrustedCertificate"',
    """
...
UlBasebandCapacity = ReplaceableObject(
    'ericsson_cm_4g."UlBasebandCapacity"',
    """
...
UtranCellRelation = ReplaceableObject(
    'ericsson_cm_4g."UtranCellRelation"',
    """
...
UtranFreqRelation = ReplaceableObject(
    'ericsson_cm_4g."UtranFreqRelation"',
    """
...
VendorCredential = ReplaceableObject(
    'ericsson_cm_4g."VendorCredential"',
    """
...
Vrrpv3Interface = ReplaceableObject(
    'ericsson_cm_4g."Vrrpv3Interface"',
    """
...
VswrSupervision = ReplaceableObject(
    'ericsson_cm_4g."VswrSupervision"',
    """
...
WcdmaSessionContinuity = ReplaceableObject(
    'ericsson_cm_4g."WcdmaSessionContinuity"',
    """
...
EUtranCellFDD = ReplaceableObject(
    ...
    SELECT 
        ...
        "systemInformationBlock3_sIntraSearchQ",
        "systemInformationBlock3_sIntraSearchP",
        "systemInformationBlock3_sNonIntraSearchQ",
        "systemInformationBlock3_sNonIntraSearchP",
        "systemInformationBlock3_threshServingLowQ",
        "systemInformationBlock3_sIntraSearchv920Active",
        ...
        "systemInformationBlock8_tReselectionCdma1xRtt",
        "systemInformationBlock8_tReselectionCdma1xRttSfHigh",
        "systemInformationBlock8_tReselectionCdma1xRttSfMedium",
        "qRxLevMin",
        "bcCdma2000SysTimeType",
        "drxActive",
        "initCdma2000SysTimeType",
        "networkSignallingValue",
        "pucchOverdimensioning",
        "qRxLevMinOffset",
        "activePlmnList_mcc",
        "activePlmnList_mnc",
        "activePlmnList_mncLength",
        "additionalPlmnList_mcc",
        "additionalPlmnList_mnc",
        "additionalPlmnList_mncLength",
        ...
        "changeNotification_changeNotificationSIB15",
        "changeNotification_changeNotificationSIB16",
        "changeNotification_changeNotificationSIB13",
        "confidence",
        "gpsTimeSFN0DecimalSecond",
        "gpsTimeSFN0Seconds",
        "latitude",
        "longitude",
        "mappingInfo_mappingInfoSIB4",
        "mappingInfo_mappingInfoSIB5",
        "mappingInfo_mappingInfoSIB6",
        "mappingInfo_mappingInfoSIB7",
        "mappingInfo_mappingInfoSIB8",
        "mappingInfo_mappingInfoSIB3",
        "mappingInfo_mappingInfoSIB10",
        "mappingInfo_mappingInfoSIB11",
        "mappingInfo_mappingInfoSIB12",
        "mappingInfo_mappingInfoSIB15",
        "mappingInfo_mappingInfoSIB16",
        "mappingInfo_mappingInfoSIB13",
        ...
        "prsConfigIndex",
        "rachRootSequence",
        "siPeriodicity_siPeriodicitySI9",
        "siPeriodicity_siPeriodicitySI8",
        "siPeriodicity_siPeriodicitySI10",
        ...
        "mixedModeRadio",
        "eutranCellPolygon_cornerLatitude",
        "eutranCellPolygon_cornerLongitude",
        "prsConfigIndexMapped",
        ...
        "acBarringForMoData_acBarringFactor",
        "acBarringForMoData_acBarringTime",
        "acBarringForMoData_acBarringForSpecialAC",
        "acBarringForMoSignalling_acBarringFactor",
        "acBarringForMoSignalling_acBarringTime",
        "acBarringForMoSignalling_acBarringForSpecialAC",
        ...
        "pciConflictCell",
        "pciDetectingCell",
        "ssacBarringForMMTELVideo_acBarringFactor",
        "ssacBarringForMMTELVideo_acBarringTime",
        "ssacBarringForMMTELVideo_acBarringForSpecialAC",
        "ssacBarringForMMTELVideoPresent",
        "ssacBarringForMMTELVoice_acBarringFactor",
        "ssacBarringForMMTELVoice_acBarringTime",
        "ssacBarringForMMTELVoice_acBarringForSpecialAC",
        "ssacBarringForMMTELVoicePresent",
        "timeOfLastModification",
        "highSpeedUEActive",
        "hostingDigitalUnit",
        "pciOSSConflictingCell",
        "advCellSupAction",
        "advCellSupSensitivity",
        "mobCtrlAtPoorCovActive",
        "sdmActive",
        "sectorCarrierRef",
        "acBarringForCsfb_acBarringFactor",
        "acBarringForCsfb_acBarringTime",
        "acBarringForCsfb_acBarringForSpecialAC",
        "externalCdma20001xRttCellRef",
        "lbUtranOffloadThreshold",
        "powerLocked",
        "zzzTemporary14",
        "zzzTemporary17",
        "snExternalCdma20001xRttCellRef",
        "commonSrPeriodicity",
        ...
        "pdcchOuterLoopInitialAdjVolte",
        "hoOptAdjThresholdAbs",
        "pdcchOuterLoopUpStepPCell",
        "crsGain",
        "pdcchTargetBler",
        "pdcchOuterLoopInitialAdjPCell",
        "cellCapMaxCellSubCap",
        "expectedMaxNoOfUsersInCell",
        "initialBufferSizeDefault",
        "pdcchTargetBlerPCell",
        "pdcchOuterLoopUpStepVolte",
        "pdcchOuterLoopInitialAdj",
        "spectrumEmissionReqMapping",
        "additionalSpectrumEmissionValues",
        "pdcchOuterLoopUpStep",
        "cioLowerLimitAdjBySon",
        "hoOptStatTime",
        "hoOptAdjThresholdPerc",
        "cioUpperLimitAdjBySon",
        "pdcchTargetBlerVolte",
        "arpPriorityLevelForSPIFHo",
        "servOrPrioRedirectEnabled",
        "servOrPrioTriggeredIFHo",
        "otdoaCheckEnabled",
        "noOfChannelSelectionSets",
        "lbabThreshRejectRateHigh",
        "prsMutingPattern",
        "prsPowerBoosting",
        "pdschTypeBGain",
        "lbabThreshRejectRateLow",
        "incrPrioServingFreqActive",
        "puschMaxNrOfPrbsPerUe",
        "lbabIncr",
        "servOrPrioTriggeredErabAction",
        "prsMutingPatternLen",
        "dummyCdmaBandClass",
        "prsTransmisScheme",
        "lbabDecr",
        "acBarringPresence_acBarringForMoDataPresence",
        "acBarringPresence_acBarringForMoSignPresence",
        "acBarringPresence_acBarringForCsfbPresence",
        "acBarringPresence_acBarringForEmergPresence",
        "lbabThreshTimeHigh",
        ...
        "lbabPeriod",
        "lbabThreshTimeLow",
        "csiRsConfigType8TxFDD",
        "tTimeAlignmentTimer",
        "cellCapMinMaxWriProt",
        "primaryPlmnAlarmSuppr",
        "lbTpNonQualFraction",
        "additionalPlmnAlarmSupprList",
        "zzzTemporary29",
        "idleModePrioAtReleaseRef",
        "zzzTemporary30",
        "zzzTemporary31",
        "lbTpRankThreshMin",
        "zzzTemporary32",
        ...
        "zzzTemporary36",
        "zzzTemporary37",
        "includeLcgInMacUeThp",
        "acBarringSkipForMmtelVideo",
        "acBarringSkipForMmtelVoice",
        "acBarringSkipForSms",
        "cceDynUeAdmCtrlOverloadThr",
        "dlDynUeAdmCtrlOverloadThr",
        "puschPwrOffset64qam",
        "ulDynUeAdmCtrlRetDiffThr",
        "dynUeAdmCtrlFilterConst",
        "cellDownlinkCaCapacity",
        "dlDynUeAdmCtrlRetDiffThr",
        "dynUeAdmCtrlEnabled",
        "servOrPrioIFHoSetupBearer",
        "ulDynUeAdmCtrlOverloadThr",
        "networkSignallingValueCa",
        "cceDynUeAdmCtrlRetDiffThr",
        "ul64qamEnabled",
        "elcEnabled",
        "estCellCapUsableFraction",
        "ulBlerTargetEnabled",
        "allocThrPucchFormat1",
        "maxSoftLockBackoffTime",
        "maxSentCrsAssistCells",
        "deallocThrPucchFormat1",
        "dlInternalChannelBandwidth",
        "transmissionMode",
        "ailgAutoRestartEnabled",
        "rtpTimeout",
        "enableUeAssistedSigReduction",
        "deallocTimerPucchFormat1",
        "primaryPsdOffset",
        "clusteredPuschMprFactor",
        "allocTimerPucchFormat1",
        "dl256QamEnabled",
        "zzzTemporary43",
        "zzzTemporary44",
        "zzzTemporary41",
        "ulInternalChannelBandwidth",
        "zzzTemporary42",
        "zzzTemporary40",
        "zzzTemporary47",
        "zzzTemporary45",
        "zzzTemporary46",
        "enableUeAssistedAdaptiveDrx",
        "spifhoSetupBearerAtInitialCtxtSetup",
        "maxNoClusteredPuschAlloc",
        "zzzTemporary38",
        "zzzTemporary39",
        "outOfCoverageSrTimerPeriodicity",
        "ulSchedCtrlForOocUesEnabled",
        "outOfCoverageThreshold",
        ...
        "ttiBundlingAfterHo",
        "adaptiveCfiHoProhibit",
        "ttiBundlingAfterReest",
        "srDetectHighThres",
        "ttiBundlingSwitchThresHyst",
        "pdcchCovImproveSrb",
        "srProcessingLevel",
        "pdschMaxNrOfPrbsPerUe",
        "ulTrigActive",
        "zzzTemporary49",
        "zzzTemporary48",
        "ulSCellPriority",
        ...
        "pdcchAdmEnabled",
        "serviceAreaId",
        "lbacThreshRejectRateLow",
        "lbacDecr",
        "lbacPeriod",
        "lbacThreshRejectRateHigh",
        "lbacThreshTimeHigh",
        "spectrumEmissionReq",
        "lbacThreshTimeLow",
        "activePlmnList",
        ...
        "reservedBy"
    FROM
    ericsson_bulkcm."vsDataEUtranCellFDD"
