"""Add migrations for Huawei WCDMA BSC6910UMTS

Revision ID: cfebec8f0555
Revises: b2031f71d167
Create Date: 2018-04-11 10:40:30.190000
...
revision = 'cfebec8f0555'
down_revision = 'b2031f71d167'
branch_labels = None
depends_on = None


def upgrade():
    op.create_table('UCELL_BSC6910UMTS',
    ...
    op.create_table('SYS_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('PICH_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VERSION', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('BCH_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('PSCH_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('CNOPERATOR_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('URA_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('LAC_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('NODEB_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
    ...
    op.create_table('NODEBALGOPARA_BSC6910UMTS',
        sa.Column('FILENAME', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('DATETIME', sa.DateTime, autoincrement=False, nullable=True),
        sa.Column('TECHNOLOGY', sa.CHAR(length=250), autoincrement=False, nullable=True),
        sa.Column('VENDOR', sa.CHAR(length=250), autoincrement=False, nullable=True),
...
def downgrade():
    op.drop_table('UCELL_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('SYS_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('PICH_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('BCH_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('PSCH_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('CNOPERATOR_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('URA_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('LAC_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('NODEB_BSC6910UMTS', schema='huawei_gexport_wcdma')
    op.drop_table('NODEBALGOPARA_BSC6910UMTS', schema='huawei_gexport_wcdma')
