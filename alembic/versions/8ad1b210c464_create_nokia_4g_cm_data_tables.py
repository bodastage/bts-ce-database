...
def downgrade():
    op.drop_table('unit', schema='nokia_raml2_lte')
    op.drop_table('uffim', schema='nokia_raml2_lte')
    op.drop_table('twamp', schema='nokia_raml2_lte')
    op.drop_table('topp', schema='nokia_raml2_lte')
    op.drop_table('topf', schema='nokia_raml2_lte')
    op.drop_table('topb', schema='nokia_raml2_lte')
    op.drop_table('tac', schema='nokia_raml2_lte')
    op.drop_table('sync', schema='nokia_raml2_lte')
    op.drop_table('submodule', schema='nokia_raml2_lte')
    op.drop_table('stpg', schema='nokia_raml2_lte')
    op.drop_table('smod', schema='nokia_raml2_lte')
    op.drop_table('sctp', schema='nokia_raml2_lte')
    op.drop_table('rmod', schema='nokia_raml2_lte')
    op.drop_table('redrt', schema='nokia_raml2_lte')
    op.drop_table('qos', schema='nokia_raml2_lte')
    op.drop_table('pmtnl', schema='nokia_raml2_lte')
    op.drop_table('pmrnl', schema='nokia_raml2_lte')
    op.drop_table('pmcadm', schema='nokia_raml2_lte')
    op.drop_table('oamprf', schema='nokia_raml2_lte')
    op.drop_table('mtrace', schema='nokia_raml2_lte')
    op.drop_table('mrbts', schema='nokia_raml2_lte')
    op.drop_table('module', schema='nokia_raml2_lte')
    op.drop_table('ltac', schema='nokia_raml2_lte')
    op.drop_table('lnrel', schema='nokia_raml2_lte')
    op.drop_table('lnmme', schema='nokia_raml2_lte')
    op.drop_table('lnhow', schema='nokia_raml2_lte')
    op.drop_table('lncel', schema='nokia_raml2_lte')
    op.drop_table('lnbts', schema='nokia_raml2_lte')
    op.drop_table('lnadjw', schema='nokia_raml2_lte')
    op.drop_table('lnadjl', schema='nokia_raml2_lte')
    op.drop_table('lnadj', schema='nokia_raml2_lte')
    op.drop_table('lcell', schema='nokia_raml2_lte')
    op.drop_table('l2swi', schema='nokia_raml2_lte')
    op.drop_table('ivif', schema='nokia_raml2_lte')
    op.drop_table('ipsecc', schema='nokia_raml2_lte')
    op.drop_table('iprtv6', schema='nokia_raml2_lte')
    op.drop_table('iprt', schema='nokia_raml2_lte')
    op.drop_table('iprm', schema='nokia_raml2_lte')
    op.drop_table('ipno', schema='nokia_raml2_lte')
    op.drop_table('intp', schema='nokia_raml2_lte')
    op.drop_table('ihcp', schema='nokia_raml2_lte')
    op.drop_table('ieif', schema='nokia_raml2_lte')
    op.drop_table('idns', schema='nokia_raml2_lte')
    op.drop_table('hw', schema='nokia_raml2_lte')
    op.drop_table('gtpu', schema='nokia_raml2_lte')
    op.drop_table('ftm', schema='nokia_raml2_lte')
    op.drop_table('ethlk', schema='nokia_raml2_lte')
    op.drop_table('ctrlts', schema='nokia_raml2_lte')
    op.drop_table('certh', schema='nokia_raml2_lte')
    op.drop_table('btsscl', schema='nokia_raml2_lte')
    op.drop_table('bfdgrp', schema='nokia_raml2_lte')
    op.drop_table('antl', schema='nokia_raml2_lte')
    op.drop_table('anrprl', schema='nokia_raml2_lte')
    op.drop_table('amgr', schema='nokia_raml2_lte')
