...
def upgrade():
    op.create_table(
        ...
        sa.Column('cpich_power', sa.Double, ),
        ...
        sa.Column('pccpch_power', sa.Double, ),
        sa.Column('sccpch_power', sa.Double, ),
        sa.Column('sch_power', sa.Double, ),
        sa.Column('hsdpa_enabled', sa.Boolean, ),
        sa.Column('hspda_power', sa.Double, ),
        sa.Column('eagch_power', sa.Double, ),
        sa.Column('ergch_power', sa.Double, ),
        sa.Column('ehich_power', sa.Double, ),
        sa.Column('hsscch_power', sa.Double, ),
        sa.Column('aich_power', sa.Double, ),
        sa.Column('pich_power', sa.Double, ),
        sa.Column('hsdpa_power', sa.Double, ),
