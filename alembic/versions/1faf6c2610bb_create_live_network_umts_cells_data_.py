...
def upgrade():
    op.create_table(
        ...
        sa.Column('lac', sa.Integer,),
        sa.Column('maximum_transmission_power', sa.Float,),
        sa.Column('secondary_sch_power', sa.Float, ),
        ...
        sa.Column('cpich_power', sa.Float, ),
        ...
        sa.Column('pccpch_power', sa.Float, ),
        sa.Column('sccpch_power', sa.Float, ),
        sa.Column('sch_power', sa.Float, ),
        sa.Column('hsdpa_enabled', sa.Boolean, ),
        sa.Column('hspda_power', sa.Float, ),
        sa.Column('eagch_power', sa.Float, ),
        sa.Column('ergch_power', sa.Float, ),
        sa.Column('ehich_power', sa.Float, ),
        sa.Column('hsscch_power', sa.Float, ),
        sa.Column('aich_power', sa.Float, ),
        sa.Column('pich_power', sa.Float, ),
        sa.Column('hsdpa_power', sa.Float, ),
