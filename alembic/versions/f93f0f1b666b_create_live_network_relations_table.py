...
def upgrade():
    op.create_table(
        ...
        sa.Column('svrnode_pk', sa.Integer, nullable=False),
        sa.Column('svrsite_pk', sa.Integer, nullable=False),
        sa.Column('svrcell_pk', sa.Integer, nullable=False),
        sa.Column('nbrnode_pk', sa.Integer, nullable=False),
        sa.Column('nbrsite_pk', sa.Integer, nullable=False),
        sa.Column('nbrcell_pk', sa.Integer, nullable=False),
        sa.Column('svrtech_pk', sa.Integer, nullable=False),
        sa.Column('nbrtech_pk', sa.Integer, nullable=False),
        sa.Column('svrvendor_pk', sa.Integer, nullable=False),
        sa.Column('nbrvendor_pk', sa.Integer, nullable=False),
